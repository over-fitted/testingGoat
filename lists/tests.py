...
class ListAndItemModelTest(TestCase):
    ...
    def test_saving_and_retrieving_items(self):
        ...
        # check that list is saved correctly
        saved_list = List.objects.first()
        self.assertEqual(saved_list, list_)
        
        # returns records as a list-like queryset, check that items saved correctly
...
class ListViewTest(TestCase):        
    def test_displays_only_items_for_that_list(self):
        ...
        Item.objects.create(text='other list item 1', list=wrong_list)
        Item.objects.create(text='other list item 2', list=wrong_list)
...
class NewListTest(TestCase):
    ...
    def test_redirects_to_correct_list_view(self):
        other_list = List.objects.create()
        correct_list = List.objects.create()
